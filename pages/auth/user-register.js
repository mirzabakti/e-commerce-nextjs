...
export default function Register() {
  ...
  const handleRegister = (e) => {
    ...
    axios
      .post("https://service-example.sanbercloud.com/api/register", { name, email, image_url, password })
      .then((res) => {
        // console.log(res)
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center">
      <div className="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
        <div className="self-center mb-6 text-xl font-light text-gray-600 sm:text-2xl dark:text-white">Register To Make Your Account</div>
        <div className="mt-8">
